...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=25,numReposBlks=25,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (BI_RBO_n,
    GND,
    S,
  ...
  wire four_2_input_nand_gate_1_Y4;
  ...
  wire four_2_input_or_gate_1_Y1;
  wire mux_8_to_1_0_Q;
  wire mux_8_to_1_1_Q;
  wire mux_8_to_1_2_Q;
  wire mux_8_to_1_3_Q;
  wire six_not_gate_0_Y1;
  wire six_not_gate_0_Y6;
  ...
  assign A1_1 = GND;
  assign S_1 = S;
  assign Y0_n = decode138_1_Y0_n;
  assign Y1_n = decode138_1_Y1_n;
  assign Y2_n = decode138_1_Y2_n;
  assign Y3_n = decode138_1_Y3_n;
  ...
  design_1_BCD2SEG7_0_0 BCD2SEG7_0
       (.BCD_A(mux_8_to_1_1_Q),
        .BCD_B(mux_8_to_1_2_Q),
        .BCD_C(mux_8_to_1_3_Q),
        .BCD_D(mux_8_to_1_0_Q),
        .BI_RBO_n(BI_RBO_n),
  ...
  design_1_clk_div_0_1 clk_div_1
       (.clk_in(clk_in_1),
  ...
  design_1_decode138_0_1 decode138_1
  ...
  design_1_four_2_input_and_gate_0_0 four_2_input_and_gate_0
       (.A1(S_1),
        .A2(six_not_gate_0_Y6),
        .A3(S_1),
        .A4(six_not_gate_0_Y6),
        .B1(xup_jk_0_Q1),
        .B2(xup_jk_0_Q1_n),
        .B3(four_2_input_nand_gate_1_Y3),
        .B4(four_2_input_nand_gate_0_Y2),
  ...
  design_1_four_2_input_and_gate_0_1 four_2_input_and_gate_1
       (.A1(S_1),
        ...
        .A3(A1_1),
        .A4(A1_1),
        .B1(four_2_input_nand_gate_1_Y4),
        .B2(four_2_input_nand_gate_0_Y3),
        .B3(A1_1),
        .B4(A1_1),
        .Y1(four_2_input_and_gate_1_Y1),
        .Y2(four_2_input_and_gate_1_Y2));
  design_1_four_2_input_and_gate_0_2 four_2_input_and_gate_2
       (.A1(xup_jk_1_Q2),
        .A2(xup_jk_1_Q2),
        .A3(two_4_input_nand_gate_0_Y1),
        .A4(two_4_input_nand_gate_0_Y2),
        .B1(tri_3_input_nand_gate_1_Y1),
        .B2(four_2_input_nand_gate_2_Y1),
        .B3(xup_jk_1_Q2_n),
        .B4(xup_jk_1_Q2_n),
  ...
  design_1_four_2_input_nand_gate_0_0 four_2_input_nand_gate_0
       (.A1(xup_jk_0_Q1_n),
        .A2(four_2_input_nand_gate_0_Y1),
        .A3(tri_3_input_nand_gate_0_Y1),
        .A4(A1_1),
        .B1(xup_jk_0_Q2_n),
        .B2(tri_3_input_nand_gate_0_Y1),
        .B3(tri_3_input_nand_gate_0_Y2),
        .B4(A1_1),
  ...
  design_1_four_2_input_nand_gate_0_1 four_2_input_nand_gate_1
       (.A1(xup_jk_0_Q1),
        .A2(xup_jk_1_Q1),
        .A3(four_2_input_nand_gate_1_Y1),
        .A4(tri_3_input_nand_gate_0_Y3),
        .B1(xup_jk_0_Q2),
        .B2(xup_jk_1_Q2),
        .B3(four_2_input_nand_gate_1_Y2),
        .B4(four_2_input_nand_gate_1_Y2),
        .Y1(four_2_input_nand_gate_1_Y1),
        .Y2(four_2_input_nand_gate_1_Y2),
        .Y3(four_2_input_nand_gate_1_Y3),
        .Y4(four_2_input_nand_gate_1_Y4));
  ...
  design_1_four_2_input_or_gate_0_1 four_2_input_or_gate_1
       (.A1(four_2_input_and_gate_2_Y4),
        .A2(A1_1),
        .A3(A1_1),
        .A4(A1_1),
        .B1(two_4_input_and_gate_0_Y1),
        .B2(A1_1),
        .B3(A1_1),
        .B4(A1_1),
        .Y1(four_2_input_or_gate_1_Y1));
  ...
  design_1_mux_8_to_1_0_1 mux_8_to_1_1
       (.A0(decimal_counter_0_Qa),
        ...
        .Q(mux_8_to_1_1_Q),
        .S_n(decimal_counter_0_Qd));
  design_1_mux_8_to_1_0_2 mux_8_to_1_2
       (.A0(decimal_counter_0_Qa),
        .A1(decimal_counter_0_Qb),
        .A2(decimal_counter_0_Qc),
        .D0(A1_1),
        .D1(four_2_input_or_gate_1_Y1),
        .D2(A1_1),
        .D3(A1_1),
        .D4(A1_1),
        .D5(A1_1),
        ...
        .Q(mux_8_to_1_2_Q),
        .S_n(decimal_counter_0_Qd));
  design_1_mux_8_to_1_0_3 mux_8_to_1_3
       (.A0(decimal_counter_0_Qa),
        .A1(decimal_counter_0_Qb),
        .A2(decimal_counter_0_Qc),
        .D0(A1_1),
  ...
  design_1_six_not_gate_0_0 six_not_gate_0
       (.A1(A1_1),
        ...
        .Y6(six_not_gate_0_Y6));
  design_1_tri_3_input_nand_gate_0_0 tri_3_input_nand_gate_0
       (.A1(xup_jk_0_Q2_n),
        .A2(xup_jk_0_Q1_n),
        .A3(xup_jk_0_Q1),
        .B1(xup_jk_1_Q1_n),
  ...
  design_1_tri_3_input_nand_gate_0_1 tri_3_input_nand_gate_1
       (.A1(decode138_0_Y2_n),
        .A2(A1_1),
        .A3(A1_1),
        .B1(decode138_0_Y3_n),
  ...
  design_1_two_4_input_nand_gate_0_0 two_4_input_nand_gate_0
       (.A1(decode138_0_Y4_n),
        .A2(decode138_0_Y2_n),
        .B1(decode138_0_Y5_n),
        .B2(decode138_0_Y3_n),
